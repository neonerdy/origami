...
namespace Origami.Security
{
    public class ActiveDirectoryHelper
    {
		...
		/// <param name="Password"></param>
		/// <returns></returns>
		public static ActiveDirectoryHelper.LoginResult  Login(string UserName, string Password)
		{
		...
		public static void EnableUserAccount(DirectoryEntry oDE)
		{
			...
			oDE.Properties["userAccountControl"][0]=ActiveDirectoryHelper.ADAccountOptions.UF_NORMAL_ACCOUNT|ActiveDirectoryHelper.ADAccountOptions.UF_DONT_EXPIRE_PASSWD;
			oDE.CommitChanges();
...
//			oDE.Invoke("accountDisabled",new Object[]{"false"});
		...
		public static void DisableUserAccount(DirectoryEntry oDE)
		{
			...
			oDE.Properties["userAccountControl"][0]=ActiveDirectoryHelper.ADAccountOptions.UF_NORMAL_ACCOUNT|ActiveDirectoryHelper.ADAccountOptions.UF_DONT_EXPIRE_PASSWD|ActiveDirectoryHelper.ADAccountOptions.UF_ACCOUNTDISABLE;
			oDE.CommitChanges();
